...
_reactDom2.default.render(_react2.default.createElement(_IndecisionApp2.default, { options: ['optn1', 'optn2'] }), document.getElementById('app'));
...
var IndecisionApp = function (_React$Component) {
	...
	function IndecisionApp(props) {
		...
		_this.handleAddOptionMead = _this.handleAddOptionMead.bind(_this);
		return _this;
	}
	...
	_createClass(IndecisionApp, [{
		...
		value: function handleAddOption(value) {
			...
			this.setState(function () {
				return {
					options: [].concat(_toConsumableArray(_this2.state.options), [value])
				};
			});
		}
	}, {
		key: 'handleAddOptionMead',
		value: function handleAddOptionMead(option) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_AddOption2.default, { handleAddOption: this.handleAddOption, handleAddOptionMead: this.handleAddOptionMead })
			);
		}
	}]);
...
var AddOption = function (_React$Component) {
	...
	function AddOption(props) {
		...
		_this.handleAddOptionHere = _this.handleAddOptionHere.bind(_this);
		_this.state = { error: undefined };
		return _this;
	}

	_createClass(AddOption, [{
		key: "handleAddOptionHere",
		value: function handleAddOptionHere(evt) {
			evt.preventDefault();
			console.log(evt.target);

			var option = evt.target.elements.add.value.trim();
			var error = this.props.handleAddOptionMead(option);
			this.setState(function () {
				return { error: error };
			});
		...
		value: function render() {
			return _react2.default.createElement(
				"form",
				{ onSubmit: this.handleAddOptionHere },
				_react2.default.createElement(
					"h3",
					null,
					"Add action"
				),
				_react2.default.createElement("input", { name: "add", type: "text", placeholder: "add action" }),
...
var Options = function Options(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'ul',
			null,
			props.options.map(function (op, i) {
				return _react2.default.createElement(
					'li',
					{ key: i },
					_react2.default.createElement(_Option2.default, { option: op, handleDeleteOption: props.handleDeleteOption })
				);
			})
		),
		_react2.default.createElement(
